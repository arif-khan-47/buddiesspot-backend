...
const { getAllProducts, updateProduct, deleteProduct, getSingleProduct, getAllCategories, updateProductCategory, createProductReview, getProductReview, deleteProductReview, getAllProductWithCategory, createProduct } = require('../controller/productController');
